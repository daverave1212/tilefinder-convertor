...
public class Item
{
    ...
    public Action<Unit onUse, ?PlayerCharacter>;
    public Action<Unit> onCombatStart;
    public Action<Unit> onCombatEnd;
	public Dynamic customData = null;

    public Func<Void appearCondition, bool>;		// If this is false, then it will not be selected for loot or shop
	...
	public inline function int getSellPrice() return Std.int(price / 5);
